...
FIXPOINT xVec(FIXPOINT speed, FIXPOINT direction) {
	if (direction == INT_TO_FIXP(270) || direction == INT_TO_FIXP(90)) return speed;
	if (direction == INT_TO_FIXP(0) || direction == INT_TO_FIXP(270)) return 0;

	else if (direction < INT_TO_FIXP(90)) {
		// X Value is +'ve
	} 
		...
		direction = FIXP_MULT(direction,INT_TO_FIXP(-1));
	}
	else {
		// X Value is -'ve
	...
	return FIXP_MULT(speed,FIXP_DIV(direction, INT_TO_FIXP(90)));
}

FIXPOINT yVec(FIXPOINT speed, FIXPOINT direction) {
	if (direction == INT_TO_FIXP(270) || direction == INT_TO_FIXP(90)) return 0;
	if (direction == INT_TO_FIXP(0) || direction == INT_TO_FIXP(270)) return speed;
	...
	return FIXP_MULT(speed,FIXP_DIV(INT_TO_FIXP(90)-direction, INT_TO_FIXP(90)));
}
